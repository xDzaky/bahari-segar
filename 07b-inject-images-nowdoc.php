  ...
  <div style="position:relative;z-index:1;display:grid;grid-template-columns:62fr 38fr;width:100%;min-height:100vh;">
    <div style="display:flex;flex-direction:column;justify-content:center;padding:120px 60px 120px 80px;">
      ...
      <div style="display:flex;gap:16px;flex-wrap:wrap;align-items:center;">
        <a href="{$WA}?text=Halo%20Bahari%20Segar%2C%20cek%20ketersediaan%20hari%20ini" target="_blank" rel="noopener" style="display:inline-block;background:#C2401C;color:#E7E9E1;font-family:Oswald,sans-serif;font-weight:700;font-size:14px;letter-spacing:0.1em;text-transform:uppercase;padding:16px 32px;text-decoration:none;">Cek Ketersediaan Hari Ini</a>
        <a href="#manifest" style="color:#E7E9E1;font-family:Oswald,sans-serif;font-weight:600;font-size:14px;letter-spacing:0.08em;text-transform:uppercase;padding:16px 0;text-decoration:none;border-bottom:2px solid rgba(243,239,228,0.3);">Lihat Kategori Produk &#8595;</a>
      </div>
    </div>
...
$stats_html = <<<'NOWDOC'
<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:24px;align-items:center;padding:36px 80px;background:#E7E9E1;">
...
<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:2px;background:#0D1316;">
  <a href="/wordpress/produk" style="display:block;position:relative;height:440px;overflow:hidden;text-decoration:none;">
    ...
    <div style="position:absolute;bottom:0;left:0;right:0;padding:36px 32px;">
      ...
      <span style="font-family:Oswald,sans-serif;font-size:12px;color:#E7E9E1;letter-spacing:0.12em;text-transform:uppercase;border-bottom:1px solid rgba(243,239,228,0.35);padding-bottom:4px;">Tanya Ketersediaan &#8594;</span>
    </div>
  </a>
  <a href="/wordpress/produk" style="display:block;position:relative;height:440px;overflow:hidden;text-decoration:none;">
...
<div style="background:#0D1316;text-align:center;padding:48px;">
  <a href="/wordpress/produk" style="display:inline-block;background:transparent;color:#E7E9E1;font-family:Oswald,sans-serif;font-weight:700;font-size:13px;letter-spacing:0.12em;text-transform:uppercase;padding:14px 40px;text-decoration:none;border:2px solid rgba(243,239,228,0.3);">Lihat Katalog Lengkap &#8594;</a>
</div>
NOWDOC;
...
<div style="background:#C2401C;padding:80px;">
  <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:40px;">
    ...
    <div style="display:flex;gap:16px;flex-wrap:wrap;">
      <a href="{$WA}?text=Halo%20Bahari%20Segar" target="_blank" rel="noopener" style="display:inline-block;background:#E7E9E1;color:#C2401C;font-family:Oswald,sans-serif;font-weight:700;font-size:14px;letter-spacing:0.08em;text-transform:uppercase;padding:18px 36px;text-decoration:none;">Chat WhatsApp Sekarang</a>
      <a href="/wordpress/kerjasama-b2b" style="display:inline-block;background:transparent;color:#E7E9E1;font-family:Oswald,sans-serif;font-weight:700;font-size:14px;letter-spacing:0.08em;text-transform:uppercase;padding:18px 36px;text-decoration:none;border:2px solid rgba(243,239,228,0.4);">Isi Form Kerjasama</a>
    </div>
  </div>
</div>
NOWDOC;
...
$beranda = [
    ...
    el_section('bs-stats',  ['background_color'=>'#E7E9E1','padding'=>['unit'=>'px','top'=>'0','right'=>'0','bottom'=>'0','left'=>'0','isLinked'=>false]],
    ...
    el_section('bs-zig',    ['background_color'=>'#E7E9E1','padding'=>['unit'=>'px','top'=>'0','right'=>'0','bottom'=>'0','left'=>'0','isLinked'=>false]],
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:start;">
    <div>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1px;background:#1E2A2A;">
        ...
        <div style="background:#0D1316;padding:32px 28px;">
          <div style="font-family:'IBM Plex Mono',monospace;font-size:36px;color:#E7E9E1;margin-bottom:8px;">50+</div>
        ...
        <div style="background:#0D1316;padding:32px 28px;">
          <div style="font-family:'IBM Plex Mono',monospace;font-size:36px;color:#E7E9E1;margin-bottom:8px;">2 Ton</div>
...
<div style="background:#C2401C;padding:80px;">
  <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:32px;">
    ...
    <div style="display:flex;gap:16px;">
      <a href="{$WA}?text=Halo%20Bahari%20Segar%2C%20saya%20ingin%20jadi%20mitra" target="_blank" style="display:inline-block;background:#E7E9E1;color:#C2401C;font-family:Oswald,sans-serif;font-weight:700;font-size:13px;letter-spacing:0.08em;text-transform:uppercase;padding:16px 32px;text-decoration:none;">Chat WhatsApp &#8594;</a>
      <a href="/wordpress/kerjasama-b2b" style="display:inline-block;background:transparent;color:#E7E9E1;font-family:Oswald,sans-serif;font-weight:700;font-size:13px;letter-spacing:0.08em;text-transform:uppercase;padding:16px 32px;text-decoration:none;border:2px solid rgba(243,239,228,0.4);">Form Kerjasama</a>
    </div>
  </div>
</div>
NOWDOC;
...
<div style="background:#12181B;padding:80px;">
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:2px;margin-bottom:2px;">
    <div style="background:#0D1316;padding:32px 28px;border-top:3px solid #C2401C;">
      <div style="font-family:Oswald,sans-serif;font-weight:700;font-size:22px;color:#E7E9E1;margin-bottom:12px;">Kakap Merah</div>
      ...
      <a href="{$WA}?text=Tanya%20stok%20Kakap%20Merah" target="_blank" style="display:inline-block;background:#C2401C;color:#E7E9E1;font-family:Oswald,sans-serif;font-weight:700;font-size:11px;letter-spacing:0.1em;text-transform:uppercase;padding:10px 20px;text-decoration:none;">Tanya Ketersediaan</a>
    </div>
    <div style="background:#0D1316;padding:32px 28px;border-top:3px solid #2E4A4A;">
      <div style="font-family:Oswald,sans-serif;font-weight:700;font-size:22px;color:#E7E9E1;margin-bottom:12px;">Kerapu Segar</div>
    ...
    <div style="background:#0D1316;padding:32px 28px;border-top:3px solid #2E4A4A;">
      <div style="font-family:Oswald,sans-serif;font-weight:700;font-size:22px;color:#E7E9E1;margin-bottom:12px;">Tuna Segar</div>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:2px;">
    <div style="background:#0D1316;padding:32px 28px;border-top:3px solid #2E4A4A;">
      <div style="font-family:Oswald,sans-serif;font-weight:700;font-size:22px;color:#E7E9E1;margin-bottom:12px;">Tenggiri Segar</div>
    ...
    <div style="background:#0D1316;padding:32px 28px;border-top:3px solid #2E4A4A;">
      <div style="font-family:Oswald,sans-serif;font-weight:700;font-size:22px;color:#E7E9E1;margin-bottom:12px;">Bawal Segar</div>
...
<div style="background:#C2401C;padding:60px 80px;">
  <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:32px;">
    ...
    <div style="display:flex;gap:16px;flex-wrap:wrap;">
      ...
      <a href="/wordpress/kerjasama-b2b" style="display:inline-block;background:transparent;color:#E7E9E1;font-family:Oswald,sans-serif;font-weight:700;font-size:13px;letter-spacing:0.08em;text-transform:uppercase;padding:16px 32px;text-decoration:none;border:2px solid rgba(243,239,228,0.4);">Ajukan Kerjasama</a>
    </div>
  </div>
</div>
NOWDOC;
